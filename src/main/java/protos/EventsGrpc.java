...
public class EventsGrpc {
  ...
  public static final io.grpc.MethodDescriptor<protos.EventsOuterClass.Event,
      protos.EventsOuterClass.Event> METHOD_CHAT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING,
          generateFullMethodName(
              "protos.Events", "Chat"),
          io.grpc.protobuf.ProtoUtils.marshaller(protos.EventsOuterClass.Event.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(protos.EventsOuterClass.Event.getDefaultInstance()));
  ...
  public static abstract class EventsImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<protos.EventsOuterClass.Event> chat(
        io.grpc.stub.StreamObserver<protos.EventsOuterClass.Event> responseObserver) {
